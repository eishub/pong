...
public class PongPanel extends JPanel {
	...
	public void paintBackground(Graphics graphics) {
		...
		if (game.getGameState()) {
			...
			graphics.drawLine(game.getWidth() / 2 - 4, 0, game.getWidth() / 2 - 4, game.getHeight());
	...
	public void paintUi(Graphics graphics) {
		...
		graphics.drawString(game.getScore(1) + "", game.getWidth() / 2 - Pong.BORDER_CORRECTION - 28, 39);
		graphics.drawString(game.getScore(2) + "", game.getWidth() / 2 - Pong.BORDER_CORRECTION + 33, 39);
	...
	public void paintGameElements(Graphics graphics) {
		...
		if (!game.getGameState()) {
			...
			graphics.drawString("Player " + won + " WON!", game.getWidth() / 2 - Pong.BORDER_CORRECTION - 95,
					game.getHeight() / 2);
			graphics.setFont(vsFont);
			graphics.drawString("press 'r' to reset", game.getWidth() / 2 - Pong.BORDER_CORRECTION - 51,
					game.getHeight() / 2 + 25);
		} else {
			// Draw ball
			graphics.setColor(Color.BLACK);
